        ...
        NavigationView {
            VStack(spacing: 0) {
                ...
                List {
                    ...
                    Section {
                        Button(action: {
                            requirePremium(.customProcedures, showPaywall: $showPremiumPaywall) {
            ...
            .premiumGate(for: .customProcedures, showPaywall: $showPremiumPaywall)
            ...
            VStack(alignment: .leading, spacing: AppTheme.Spacing.xxs) {
                HStack(spacing: AppTheme.Spacing.xs) {
                    Text(procedure.name)
                        ...
                        .fontWeight(.medium)
                        .foregroundStyle(procedure.isEnabled ? AppTheme.Colors.textPrimary : AppTheme.Colors.textTertiary)
        ...
        VStack(spacing: AppTheme.Spacing.md) {
            ...
            HStack(spacing: AppTheme.Spacing.md) {
                Circle()
                    ...
                    .overlay(
                        Circle()
                            .stroke(AppTheme.Colors.surface, lineWidth: 3)
                    )
                ...
                Text(name.isEmpty ? "Procedure Name" : name)
                    ...
                    .fontWeight(.semibold)
                    .foregroundStyle(name.isEmpty ? AppTheme.Colors.textTertiary : AppTheme.Colors.textPrimary)
            }
