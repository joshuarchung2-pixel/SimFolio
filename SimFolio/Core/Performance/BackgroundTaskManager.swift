...
// SimFolio - Background Task Management
//
...
class BackgroundTaskManager {
    ...
    private let exportTaskIdentifier = "com.simfolio.export"

    /// Identifier for cleanup task
    private let cleanupTaskIdentifier = "com.simfolio.cleanup"

    /// Identifier for sync task
    private let syncTaskIdentifier = "com.simfolio.sync"
    ...
    func registerBackgroundTasks() {
        ...
        BGTaskScheduler.shared.register(
            ...
            self.handleExportTask(processingTask)
        }
        ...
        BGTaskScheduler.shared.register(
            ...
            self.handleCleanupTask(refreshTask)
        }
