...
// SimFolio - Permission Denied Views
//
...
enum PermissionDeniedType {
    ...
    var message: String {
        switch self {
        case .camera:
            return "SimFolio needs camera access to capture your clinical photos. Please enable it in Settings."
        case .photos:
            return "SimFolio needs access to your photo library to save and organize your photos. Please enable it in Settings."
        case .notifications:
