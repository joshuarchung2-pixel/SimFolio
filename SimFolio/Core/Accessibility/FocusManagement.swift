...
// SimFolio - Accessibility Focus Management
//
...
struct AccessibleFocusWrapper<FocusValue: Hashable, Content: View>: View {
    ...
    let content: (AccessibilityFocusState<FocusValue?>.Binding) -> Content

    init(
        focus: Binding<FocusValue?>,
        @ViewBuilder content: @escaping (AccessibilityFocusState<FocusValue?>.Binding) -> Content
    ) {
