...
// - angles: Required angles (e.g., ["Occlusal/Incisal", "Buccal/Facial"])
...
struct PortfolioRequirement: Codable, Identifiable, Hashable {
    ...
    var angles: [String]            // e.g., ["Occlusal/Incisal", "Buccal/Facial"]
    var angleCounts: [String: Int]  // Per-angle photo counts, e.g., ["Occlusal/Incisal": 2, "Buccal/Facial": 1]
